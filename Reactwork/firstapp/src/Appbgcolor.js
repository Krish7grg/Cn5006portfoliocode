...
function greetUser(e) { document.body.style.background = e.target.value; alert("Welcome Mr"+ document.getElementById(props.color).value)
      }
return (
<body style={{backgroundcolor:'powderblue',color:'black'}}>
    <div className="App">
<h1>{props.heading} </h1>
<p style={{color:'black',font: '30px Arial'}}> How to create function component.</p>
