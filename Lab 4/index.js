//exercise 1
//basic express hello application

var express=require("express")
var fs= require("fs")

var app=express()   //create function
...
app.get('/contact', function(req, res){
    res.send("This is called contact")
})
...
app.get('/GetStudents',function (req,res)
 { studentdata={}
  fs.readFile(__dirname + "/" + "Student.json", 'utf8',  //__dirname is used to get the directory name of the currently executing file.
...
app.listen(8000,function()  //defining server
