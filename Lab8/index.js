...
// creating model named as modelname with collection named as person_Collection
const person_doc = mongoose.model('modelname', PersonScheme,'person_Collection');
...
//find documents with the given criteria
    var givenage=30
    person_doc.find({Gender:"Female",age:{$gte:givenage}}) //find all user
    .sort({salary: 1})
    .select('name Salary age')
    .limit(10)
    .exec()
